...
public class BossCreature3 extends Entity {

    private static final int poly_w = 15;
    private static final int poly_l = 90;
    ...
    public BossCreature3(int x, int y, Color color) {
        super(body, x, y);
